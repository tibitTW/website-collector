...
<template>
    <div ref="dividerRef" class="divider relative [&_*]:cursor-col-resize" @mousedown="startResize"
        @touchstart="startResize">
        <div
            class="absolute inset-0 h-full w-[var(--divider-width)] bg-[var(--divider-bg-color)] flex items-center justify-center">
            <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[var(--divider-active-width)] z-10 h-full bg-[var(--divider-active-bg-color)] opacity-0 transition-all duration-300 delay-0 hover:opacity-100 hover:delay-100"
